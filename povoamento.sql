...
INSERT INTO Trabalha (CPF_Func, Data_Admissao, ID_Setor) VALUES 
  ('4', TO_DATE('2020-01-10','YYYY-MM-DD'), 555),
  ('7', TO_DATE('2021-06-15','YYYY-MM-DD'), 666),
  ('3', TO_DATE('2019-04-10','YYYY-MM-DD'), 111),
  ('6', TO_DATE('2022-03-20','YYYY-MM-DD'), 222),
  ('5', TO_DATE('2023-07-30','YYYY-MM-DD'), 333),
  ('8', TO_DATE('2022-05-01','YYYY-MM-DD'), 444);
